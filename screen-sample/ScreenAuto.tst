// File name: projects/IO_ASM/screen/SreenAuto.tst
...
load Screen.asm,
output-file ScreenAuto.out,
compare-to ScreenAuto.cmp,
...
set RAM[24576] 70,    // a keyboard key is pressed
repeat 1000000 {
  ticktock;
}
...
set RAM[24576] 84,    // they keyboard in untouched
repeat 1000000 {
  ticktock;
}
output;              // test that the screen is white
...
set RAM[24576] 66,    // they keyboard in untouched
repeat 1000000 {
  ticktock;
}
output;              // test that the screen is white
